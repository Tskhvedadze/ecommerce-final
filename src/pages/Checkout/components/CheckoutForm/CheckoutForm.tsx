            ...
            <Form className='mt-2 flex flex-col space-y-4'>
              ...
              <WFull>
                {errors.cardNumber && touched.cardNumber ? (
                  <ErrorMsg name='cardNumber' component='span' />
                ) : (
              ...
              <ExpSecuContainer>
                <div>
                  <div>
                    {errors.year && touched.year ? (
                      <ErrorMsg name='year' component='span' />
                    ) : (
                  ...
                  <div>
                    {errors.month && touched.month ? (
                      <ErrorMsg name='month' component='span' />
                    ) : (
                ...
                <div>
                  {errors.CVV && touched.CVV ? (
                    ...
                    <Label htmlFor='CVV'>{t('security')}</Label>
                  )}
                  <Field
                    type='number'
                    id='CVV'
              ...
              <div>
                {errors.cardName && touched.cardName ? (
                  <ErrorMsg name='cardName' component='span' />
                ) : (
              ...
              <Button mode='order' type='submit'>
                {loading ? <Spin className='py-1' /> : `${t('order')}`}
              </Button>
            </Form>
          )}
        </Formik>
