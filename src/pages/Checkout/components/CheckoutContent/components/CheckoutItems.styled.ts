...
export const Quantity = styled.span`
  ${tw`text-lg font-semibold w-12 text-center text-gray-700`}
`
...
export const Delete = styled(RiDeleteBin6Line)`
  ${tw`text-red-400 ml-3 mb-1 cursor-pointer transition-colors duration-200 hover:text-red-200 active:text-red-600 h-6 w-6`}
`
